...
export const services: Service[] = [
  {
    ...
    whatWeDo: [
      'Tariff, Open Access & Regulatory Litigation before Electricity Regulatory Commissions and APTEL',
      'Power Purchase Agreements, Renewable Energy & Captive/Distributed Generation',
      'Billing Disputes: Challenging inflated bills, incorrect arrears, average billing & wrongful tariff classification',
      'Disconnection & Restoration: Challenging unlawful disconnections and securing prompt restoration of electricity supply',
